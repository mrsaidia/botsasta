...
let currentView = localStorage.getItem('adminCurrentHistoryView') || 'cards'; // 'cards' or 'table'
...
function initializeHistoryFeatures() {
    ...
    const savedView = localStorage.getItem('adminCurrentHistoryView') || 'cards';
        ...
        ">
            ...
            ">
                ...
                <div style="padding: 2rem;">
                    ...
                    <div style="margin-bottom: 2rem;">
                        <h4 style="color: #2d3748; margin-bottom: 1rem; display: flex; align-items: center; gap: 0.5rem;">
                            <i class="fas fa-user-circle" style="color: #667eea;"></i> Account Details
                        </h4>
...
async function editCouponCode(id) {
    ...
    try {
        ...
        // Create edit modal
        const modalHTML = `
            <div class="modal-overlay" id="editCouponModalOverlay" style="display: block;">
                <div class="modal user-discount-modal" id="editCouponModal">
                    <div class="modal-content">
                        <div class="modal-header" style="background: #667eea; color: white;">
                            <h3><i class="fas fa-edit" style="margin-right: 10px;"></i>Edit Coupon Code</h3>
                            <button class="modal-close" onclick="closeEditCouponModal()" style="color: white;">&times;</button>
                        </div>
                        ...
                        <div class="modal-footer" style="padding: 15px 20px; text-align: right; border-top: 1px solid #eee;">
                            ...
                            <button type="button" class="btn btn-primary" onclick="updateCouponCode(${id})">
        ...
        document.getElementById('editCouponCode').addEventListener('input', function(e) {
...
// Sửa renderUsersTable để dùng filteredUsersData nếu có
function renderUsersTable() {
    const tbody = document.getElementById('usersTableBody');
    tbody.innerHTML = '';
    const data = (typeof filteredUsersData !== 'undefined' && filteredUsersData.length > 0) || document.getElementById('searchUserInput')?.value ? filteredUsersData : usersData;
